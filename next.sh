...
#/usr/local/MATLAB/MATLAB_Production_Server/R2013a/bin/./matlab -nodisplay -nodisplay -nosplash -r \
#matlab -nodisplay -nodisplay -nosplash -r \
#/usr/local/MATLAB/MATLAB_Production_Server/R2013a/bin/./matlab -nodisplay -nodisplay -nosplash -r \
#/usr/local/MATLAB/MATLAB_Production_Server/R2013a/bin/./matlab -nodisplay -nodisplay -nosplash -r \
matlab -nodisplay -nodisplay -nosplash -r \
    "try addpath(genpath('sources')); \
     eval_record('$RECORD'); \
     catch e; display(getReport(e)); exit(1); end; quit"
XGBOOST='python xgBoostClassifyPCG.py $RECORD >> answers.txt'
